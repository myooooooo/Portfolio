...
const ProjectDetail: React.FC<ProjectDetailProps> = ({ project, onBack }) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] bg-white flex flex-col md:flex-row animate-fade-in-up overflow-hidden">
      ...
      {/* ------------------------------------------------------- */}
      <div className="w-full md:w-[35%] lg:w-[30%] h-auto md:h-full border-b md:border-b-0 md:border-r border-black flex flex-col justify-between bg-white z-20 shrink-0 md:overflow-y-auto scrollbar-hide">
         ...
         <div className="p-6 md:p-8 lg:p-10 pb-0">
            ...
            <div className="mb-8">
                ...
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-black uppercase tracking-tighter leading-[0.85] text-luxe-black break-words hyphens-auto">
                    {project.title}
                </h1>
            </div>
         ...
         <div className="mt-auto">
            ...
            <div className="grid grid-cols-2 border-t border-black">
                ...
                <div className="p-6 md:p-8 bg-black text-white cursor-pointer hover:bg-pop-pink transition-colors flex items-center justify-center group" onClick={() => project.link && window.open(project.link)}>
      ...
      {/* ------------------------------------------------------- */}
      <div className="w-full md:w-[65%] lg:w-[70%] h-full overflow-y-auto bg-gray-50 relative flex flex-col">
         ...
         {allImages.map((img, idx) => (
            <div key={idx} className="w-full relative group">
                <div className="relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-pop-pink/10 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none mix-blend-multiply"></div>
                    
                    <div className="absolute top-6 right-6 bg-white border border-black px-3 py-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300 translate-y-4 group-hover:translate-y-0">
                ...
                <div className="bg-white border-b border-black py-3 px-6 flex justify-between items-center">
                    <span className="text-[10px] font-bold uppercase tracking-widest text-gray-400">{img.label}</span>
                    <span className="text-[10px] font-mono font-bold">IMAGE_DATA_0{idx + 1}</span>
                </div>
            </div>
         ))}
         ...
         <div className="bg-luxe-black text-white p-20 text-center mt-auto flex flex-col items-center justify-center min-h-[50vh]">
            <span className="text-pop-pink text-4xl mb-4 animate-bounce">↓</span>
